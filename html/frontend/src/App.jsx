			...
			<div>
				...
				<div>
					<div className="category-container">
						<div id="card-games" className="page-category">
							CARD GAMES
						</div>
					</div>
					<div id="card-games" className="game-browser">
						<div id="game-fish" className="game">
							<div id="fish-menu" className="game-menu">
								<div id="fish-thumbnail" className="thumbnail">
							...
							<div className="game-information">
								...
								<div className="button-container">
									<button className="play-button">
										<Link to="/Fish"> PLAY NOW </Link>
									</button>
								</div>
								<div className="player-counter-container">
									<div className="player-counter-title">
										PLAYERS ACTIVE
									</div>
					...
					<div className="category-container">
						<div id="board-games" className="page-category">
							BOARD GAMES
						</div>
					</div>
					<div id="board-games" className="game-browser">
						<div id="game-pioneers" className="game">
							<div id="pioneers-menu" className="game-menu">
								<div id="pioneers-thumbnail" className="thumbnail">
					...
					<div className="category-container">
						<div id="nutty-casino" className="page-category">
							NUTTY CASINO
						</div>
					</div>
					<div id="board-games" className="game-browser">
