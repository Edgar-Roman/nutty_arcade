...
class Fish extends React.Component {
    ...
    render(){
        ...
        for (let i = 0; i < 2; i ++){
            teammates.push(<option className="white" key={i} value={this.state.teamMap[this.state.playerID][i]}>{this.state.names[this.state.teamMap[this.state.playerID][i]]}</option>)
        }
