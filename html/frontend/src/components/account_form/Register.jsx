                ...
                <div className="account-form-container">
                    <form className="account-form-panel" id="register-panel">
                        ...
                        <div className="account-form-button-container">
                            <button className="account-form-button" onClick={this.register_user}>Register</button>
                        </div>
                        {/* Switch To Login Button */}
                        <div className="account-form-button-container">
                            <Link className="account-form-button" to="/">
                                <button className="account-form-button">Log-In</button>
                            </Link>
                        </div>
                    </form>
                </div>
